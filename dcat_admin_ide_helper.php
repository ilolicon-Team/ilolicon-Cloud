...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection max_user
     ...
     * @method Grid\Column|Collection max_user(string $label = null)
     ...
     * @property Show\Field|Collection max_user
     ...
     * @method Show\Field|Collection max_user(string $label = null)
